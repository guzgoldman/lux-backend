...
exports.listarCorrelativas = async (req, res, next) => {
    ...
    try {
        ...
        const correlativas = await Correlativa.findAll({
            ...
            include: [
                { model: MateriaPlan, as: 'correlativa',
                    include: [
                        { model: Materia, as: 'materia' }, // Incluir el nombre de la materia correlativa
                        { model: PlanEstudio, as: 'planEstudio' } // Incluir el plan de estudio de la materia correlativa
                    ]
                }
            ]
        });
